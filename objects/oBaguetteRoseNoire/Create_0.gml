...
array_push(effects, { trigger: TRIGGER_CONTINUOUS, effect_type: EFFECT_EQUIP_APPLY_BUFF, base_buff: 500, extra_buff: 500, bonus_if_names: ["oPetiteSorciereDeLaRoseNoire", "oSorciereDeLaRoseNoire", "oEruditDeLaRoseNoire"], description: "Le monstre équipé gagne 500/500 (+500/500 si Rose noire)." });
